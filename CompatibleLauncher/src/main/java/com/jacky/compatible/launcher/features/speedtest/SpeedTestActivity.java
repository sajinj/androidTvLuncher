...
public class SpeedTestActivity extends Activity implements OnClickListener {
    ...
    private Button didNotStart;     // has not started
    private Button inStart;     // Started
    private Button startAgain;      // Start again
    private LinearLayout didNotStartLayout;
    private LinearLayout inStartLayout;
    private LinearLayout startAgainLayout;
    private long currenSpeed;       // Current Speed
    private long averageSpeed;      // Average speed
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case SPEEDUPDATE:
                    ...
                    if (averageSpeed <= 200) {
                        movieType.setText(getResources().getString(R.string.puqing_movie));
                    } else if (averageSpeed <= 400) {
                        movieType.setText(getResources().getString(R.string.hd_movie));
                    } else if (averageSpeed > 400) {
                        movieType.setText(getResources().getString(R.string.ultra_clear_movie));
                    }
                    speedTaital = 0;
                    break;
                case SPEED_FINISH:
