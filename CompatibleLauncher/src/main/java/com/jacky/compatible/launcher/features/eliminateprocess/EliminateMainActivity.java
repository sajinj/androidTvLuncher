...
public class EliminateMainActivity extends Activity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case CLEAR_FINISH:
                    ...
                    startKill.setText(getResources().getString(R.string.clean_up));
                    break;
                case NEEDENT_CLEAR:
                    percentnum = String.valueOf(0);
                    clearMemory = String.valueOf(0);
                    Toast.makeText(EliminateMainActivity.this, getResources().getString(R.string.no_current_cleanup_required), Toast.LENGTH_LONG).show();
                    break;
                case PERCENT_CHANGE:
    ...
    // Load all acquired application information
