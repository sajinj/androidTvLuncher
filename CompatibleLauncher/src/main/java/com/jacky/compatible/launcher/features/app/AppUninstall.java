...
import com.jacky.compatible.launcher.adapter.AppUninstallAdapter;
...
/**
 * Application uninstallation class
 * @author jacky
 * @version 1.0
 * @since 2016.4.1
 */
public class AppUninstall extends Activity implements View.OnClickListener {
    ...
    private class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            // Receive installation broadcast
