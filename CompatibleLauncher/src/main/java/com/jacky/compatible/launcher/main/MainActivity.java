...
package com.jacky.compatible.launcher.main;
...
import com.jacky.compatible.launcher.adapter.MainActivityAdapter;
import com.jacky.compatible.launcher.features.LocalServiceFragment;
import com.jacky.compatible.launcher.features.app.AppFragment;
import com.jacky.compatible.launcher.features.indicator.TabIndicator;
import com.jacky.compatible.launcher.features.setting.SettingFragment;
import com.jacky.compatible.launcher.features.viewpager.DefaultTransformer;
import com.jacky.compatible.launcher.features.viewpager.FixViewpagerScrollerSpeed;
...
public class MainActivity extends BaseTitleActivity implements View.OnClickListener, TabIndicator.onTabChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setPageTransformer(true, (ViewPager.PageTransformer) new DefaultTransformer());
